...
public class InvalidAttributesTests
{
    ...
    {
        var a = new BadKeyMembersBag { Items = [new Item { Name = "a", X = 1 }, new Item { Name = "b", X = 2 }] };
        var b = new BadKeyMembersBag { Items = [new Item { Name = "b", X = 2 }, new Item { Name = "a", X = 1 }] };
        var c = new BadKeyMembersBag { Items = [new Item { Name = "a", X = 1 }] };
