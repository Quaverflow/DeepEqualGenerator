...
public partial class DCustomer
{
    ...
    public string? Name
    {
        ...
        {
            _Name = value;
            __MarkDirty(__Bit_Name);
        }
    }

    public DAddress? Home
    {
        get => _Home;
        set
        {
            _Home = value;
            __MarkDirty(__Bit_Home);
        }
    }
}
...
public partial class DOrder
{
    ...
    public DCustomer? Customer
    {
        get => _Customer;
        set
        {
            _Customer = value;
            __MarkDirty(__Bit_Customer);
        }
    }
...
{
    private static ComparisonContext CtxFast()
    {
        return new ComparisonContext(new ComparisonOptions { ValidateDirtyOnEmit = false });
    }

    private static ComparisonContext CtxValidate()
    {
        return new ComparisonContext(new ComparisonOptions { ValidateDirtyOnEmit = true });
    }

    private static DOrder NewOrder()
    {
        return new DOrder
        {
            Id = 1,
    ...
    private static DOrder Clone(DOrder s)
    {
        return new DOrder
        {
            Id = s.Id,
    ...
    private static void CleanDirty<T>(T obj)
    {
        ...
        void Recurse(object? o)
        {
            ...
            if (hasAny is not null && tryPop is not null)
            {
                ...
                while ((bool)tryPop.Invoke(o, args)!) args[0] = null;
            }
    ...
    {
        var a = new DOrder_TS { Id = 1, Notes = "n", Items = [new DItem { Sku = "A", Qty = 1 }] };
        CleanDirty(a);
        var b = new DOrder_TS { Id = 2, Notes = "m", Items = [new DItem { Sku = "A", Qty = 1 }] };
        CleanDirty(b);
    ...
    public void Dirty_ListItem_Edit_No_Container_Bit_Falls_Back_To_Correct_Result()
    {
        ...
        var looksGranular =
            ...
            || doc.Operations.Any(o =>
                ...
                (o.Value is IList<DItem> ||
                 o.Value is IReadOnlyList<DItem>));
