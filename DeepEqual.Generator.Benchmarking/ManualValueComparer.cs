...
static class ManualValueComparer
{
    ...
    private static bool ArrayEqual(Array a, Array b)
    {
        ...
        {
            return SequenceEqual(ai, bi);
        }

        if (a is string[] as1 && b is string[] bs1)
        {
            return SequenceEqual(as1, bs1);
        }
